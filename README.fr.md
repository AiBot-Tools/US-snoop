...
<a href="https://raw.githubusercontent.com/snooppr/snoop/master/websites.md" Target="_blank"><img src="https://img.shields.io/badge/Snoop-~5300+%20sites Internet-success" width="50%" /></a>  
...
[Base de données de la version complète de Snoop 5300+ sites Web ⚡️⚡️⚡️](https://raw.githubusercontent.com/snooppr/snoop/master/websites.md "Database Snoop")  
...
# Sur le système d'exploitation Windows, utilisez CMD, mais pas WSL!
# Système d'exploitation Windows. Si les polices de l'utilisateur ne s'affichent pas correctement,
# faites un clic droit dans cmd, propriétés et sélectionnez la police : « Lucida Console » ou « TrueType ».
...
search arguments:
  ...
  --web-base, -w        Connectez-vous pour rechercher 'surnom' dans la base de
                        données web mise à jour (plus de 5300+ sites Web). 
...
$ python3 snoop.py olesya #Exécution à partir de la source
